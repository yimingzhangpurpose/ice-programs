...
def yeda34(fileloc, filetype, date, option1, option2, tickerlist):
    ...
    dirpath = "/".join(["/space/common/workspace/phase3_output/program4_out", filetype, date]) + "/"
    ...
    print("Getting data and generating plot...")
    val_ticker = []
    ...
    ax.legend()
    imgname = ins + "_" + "trades_" + "Volume" + filetype + "_" + date + ".png"
